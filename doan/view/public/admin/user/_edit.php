...
<body>
    ...
    <form action="<?= url('admin.user.edit') ?>" method="post" enctype="multipart/form-data/">
        ...
        <div class=" p-6 w-4/5 mx-auto pb-0 mb-0 bg-red border-b-0 border-b-solid rounded-t-2xl border-b-transparent flex flex-row">
            <a href="<?= url('admin.user.index') ?>" class=" mt-2 ml-auto bg-gray-600 hover:bg-gray-800 text-red font-bold py-2 px-4 border border-green-700 rounder">BACK</a>
        </div>
        <div class="mx-auto w-1/2">
            ...
            <button class="bg-green-500 hover:bg-green-700 text-red font-bold py-2 px-3 border mx-80 rounded " type="submit">SAVE</button>
